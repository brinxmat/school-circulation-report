...
function getJavascript (data) {
  ...
  return '\n'
    ...
    + '  var collator = new Intl.Collator("nb");\n'
    ...
    + '    function (a, b) {\n'
    + '      return reverse\n'
    + '        * collator.compare(a.cells[col].textContent.trim(), b.cells[col].textContent.trim());\n'
    + '    }\n'
    + '  );\n'
    + '  for(i = 0; i < tr.length; ++i) tb.appendChild(tr[i]);\n'
    + '}\n\n'
    + 'function makeSortable(document, table) {\n'
    ...
    + '  }(i));\n'
    + '}\n\n'
    + 'function addDirection (document, table, element, dir) {\n'
    + '        var className = "direction-decorator";\n'
    + '        var decorators = table.getElementsByClassName(className);\n'
